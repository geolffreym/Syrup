...
Files = function ( persist, bytes_amount ) {
	...
	this.requestFile = (_.isSet ( _w.webkitRequestFileSystem ) && _w.webkitRequestFileSystem)
		|| (_.isSet ( _w.mozRequestFileSystem ) && _w.mozRequestFileSystem)
		|| (_.isSet ( _w.requestFileSystem ) && _w.requestFileSystem);
