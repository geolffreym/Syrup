	...
	return {
		...
		manage:   function ( object ) {
			var _style = _.isSet ( object.object.style ) ? object.object.style : 'default',
			    ...
			    _in = _.isSet ( object.object.in ) ? object.object.in : [
				    {left: '-30%'},
				    {left: '3%'}
			    ],
			    _out = _.isSet ( object.object.out ) ? object.object.out : [
				    {left: '3%'},
				    {left: '-30%'}
			    ];
			...
			self.dom
				.addClass ( _style )
				.animate ( _in, {duration: Math.round ( _delay / 2 )}, function ( elem ) {
				elem.css ( {left: "3%"} );
				elem.animate ( _out, {delay: _delay}, function ( elem ) {
					elem.css ( {left: "-30%"} );
				} );
			} )
