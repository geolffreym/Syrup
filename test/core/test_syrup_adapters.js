...
describe('Syrup.adapters', function () {

	//TODO escribir pruebas para confirmar los adaptadores implementan iAdapter
	it('should implement iAdapter', function () {

	});

	//TODO escribir pruebas para confirmar los adaptadores implementan iAdapter
	it('should JQueryAdapter implement iAdapter', function () {
